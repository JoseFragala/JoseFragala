...
Atualmente, estou cursando **Análise e Desenvolvimento de Sistemas**, onde tenho direcionado meus estudos para **Inteligência Artificial**, automações e construção de soluções práticas. Recentemente iniciei um **bootcamp de IA**, ampliando meu repertório em modelos generativos, agentes, cloud e boas práticas de desenvolvimento.

No GitHub, publico projetos reais que desenvolvo ao longo da faculdade e dos meus estudos — como sistemas voltados para automação, IA aplicada e projetos utilitários do dia a dia.
